...
export function EyeSlash({className}) {
    return (
        <svg 
            xmlns="http://www.w3.org/2000/svg" 
            fill="none" 
...
export function EllipsisVertical({className}) {
    return (
        <svg 
            xmlns="http://www.w3.org/2000/svg" 
            fill="none" 
...
export function CurrencyDollar({ className }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
...
export function Email({ className, tooltip }) {
    return (
        <div className="group relative flex justify-center">      
            <svg
                xmlns="http://www.w3.org/2000/svg"
...
export function Phone({ className, tooltip }) {
    return (
        <div className="group relative flex justify-center">      
            <svg
                xmlns="http://www.w3.org/2000/svg"
...
export function Station({ className, tooltip }) {
    return (
        <div className="group relative flex justify-center">      
            <svg
                xmlns="http://www.w3.org/2000/svg"
