            ...
            >
                <div className="flex flex-col md:flex-row border-0 gap-5 md:px-10 md:mt-10 md:mb-2">
                    <div className="md:w-full">
                        ...
                        <div className="p-10 border-0 bg-light w-full h-full flex items-center ">
                            <div className="flex items-center gap-10">
                                <div className="border-0 h-[20rem] w-[20rem]">
                                    {/* Conditional image rendering based on gender */}
                                    {userLogIn.gender === "Male" ? (
                                        <img
                                            src="../image/boy.jpg"
                                            alt="Male Image"
                                            className="w-auto h-auto rounded-full object-cover border border-gray-300 shadow-md"
                                        />
                                    ) : userLogIn.gender === "Female" ? (
                                        <img
                                            src="../image/girl.jpg"
                                            alt="Female Image"
                                            className="w-auto h-auto rounded-full object-cover border border-gray-300 shadow-md"
                                        ...
                                        // Fallback image if gender is neither Male nor Female
                                        <img
                                ...
                                <div className="border-0">
                                    <h1 className="block text-dark text-[2.5rem] font-semibold text-wrap gap-2">
                                        ...
                                        <span className="ml-2">{userLogIn.last_name}</span>
                                    </h1>
                    ...
                    <div className="md:w-1/2">
                        {!showResetPassword ? (
                            <>
                                <div for="last_name" className=" bg-[#F2D323] shadow-md border-b border flex justify-center  rounded-lg  text-nowrap  ">
                                ...
                                <div className="flex justify-center">
                                    <div
                                        ...
                                        className="mt-4 md:w-7/12 text-light py-2 px-4 w-full border-yellow-500 rounded-md mb-2 transform flex justify-center text-nowrap items-center cursor-pointer border-2 border-transparent hover:border-yellow-500 hover:bg-yellow-100"
                                    >
                                        <Plus className="h-4" />
