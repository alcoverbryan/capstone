...
export default function AddDailySalesValue() {
    ...
    return (
        <div>
            <Modal title="Daily Sales Value" span={<span className="flex items-center gap-1 p-3 py-2 bg-[#E63946] text-[#FFFFFF] rounded-md hover:bg-[#D62839] cursor-pointer"><PlusCircle className="w-5 h-5"/>Daily Sales Value</span>}>
