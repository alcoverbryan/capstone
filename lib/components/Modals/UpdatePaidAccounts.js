...
export default function UpdatePaidAccounts({ userLogIn, account, handleChargeAccountSave }) {
    ...
    const handleSubmit = async (e) => {
        ...
        const updatedAccountData = {
            ...
            ammount_paid: parseFloat(amountPaid) || 0, // Adding amount_paid field
            ewt: parseFloat(ewt) || 0, // Adding ewt field
            terms: e.target.terms.value,
            bank: e.target.bank.value, // Adding bank field
            check_no: e.target.check_no.value, // Adding check_no field
            cr_num: e.target.cr_num.value, // Adding cr_num field
            date_collected: e.target.date_collected.value, // Adding date_collected field
        };
