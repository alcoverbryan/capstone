...
export default function AddDailyDipModal() {
    ...
    return (
        <div>
            <Modal span={<span className="px-4 py-2 bg-[#E63946] text-[#FFFFFF] rounded-md hover:bg-[#D62839] cursor-pointer">Daily Dip</span>}>
                <div className="mt-1 mb-2 font-bold text-lg text-gray-700">Actual 6am Dip</div>
