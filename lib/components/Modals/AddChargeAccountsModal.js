                            ...
                            <tr key={index} className={`row-${index}`}>
                                ...
                                <td className="border border-black">
                                    <input
                                        ...
                                        value={row.soa}
                                        onChange={(e) => handleChange(index, e)}
                                        className="w-52 border-none focus:ring-0 focus: outline-none px-1 py-0"
                                        required
                                    />
                                </td>
                                <td className="border border-black">
                                    <textarea
                                        ...
                                        value={row.cust_name}
                                        onChange={(e) => handleChange(index, e)}
                                        className="flex w-56 border-none item focus:ring-0 focus: outline-none px-1 py-0 resize-none overflow-hidden"
                                        rows="1"
                                        required
                                ...
                                <td className="border border-black">
                                    <input
                                        ...
                                        value={row.ammount}
                                        onChange={(e) => handleChange(index, e)}
                                        className="w-32 border-none focus:ring-0 focus: outline-none px-1 py-0"
                                        required
                                    />
                                </td>
                                <td className="border border-black">
