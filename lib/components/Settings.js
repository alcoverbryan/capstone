...
export default function Settings({ userLogIn, getPendingUsers, displayAllPendingPassword, allBranch }) {
    // State Variables
    ...
    const renderView = () => {
        switch (viewMode) {
            ...
            case "branch_info":
                return (
                    <div className="md:px-10">
                        <BranchInformation allBranch={allBranch} userLogIn={userLogIn} />
                        <h2 className="text-xl font-semibold text-center">
                            Branch Information Management
                        </h2>
                        <p className="text-center mt-4">
                        Here you can edit and manage branch information.
                        </p>
                    </div>
                );
            default:
                ...
                <div>
                    ...
                    <div className="flex md:flex-row flex-col items-center md:gap-1 justify-center mt-10">
                        <div className="flex gap-10 justify-center md:mt-0 mt-5">
                            ...
                            <div className="relative flex justify-center items-center">
                                <button
                                    onClick={() => handleButtonClick("branch_info")}
                                    className={`p-2 px-6 md:w-auto w-full rounded-full text-sm font-semibold border ${
                                        activeButton === "branch_info" ? "bg-[#F2D323] text-light" : ""
                                    }`}
                                >
                                    <div className="flex items-center justify-center gap-2">
                                        <span className="md:text-[14px] text-nowrap text-[12px]">
