        ...
        <>
            <div className="flex justify-between mb-10 p-4 shadow-md bg-white items-center">
                ...
                <div className="flex gap-5 items-center">
                    {view === 'actual' && <AddBranchModal userLogIn={userLogIn} handleFuelPricesSave={handleFuelPricesSave} />}
                </div>
            </div>
            ...
            <ActualFuelPrices allFuelPrices={allFuelPrices} showGraph={showGraph} userLogIn={userLogIn} handleFuelPricesSave={handleFuelPricesSave}/>
