                    ...
                    {/* <div className="md:w-full">
                        ...
                        <div className="md:w-auto">
                            <div className=" w-full  bg-light shadow-lg border-b border rounded-lg  flex justify-center ">
                                <div className="border-0 mb-10 w-100">
                                    ...
                                    <div className="w-full border-0  mt-5 px-4">
                                        <form action="/api/updateMemberDetails" method="POST" className="">
                                            ...
                                            <div className="relative flex items-center">
                                                ...
                                                {/* Icon Section */}
                                                <div className="absolute top-0 left-0 h-full flex items-center pl-2 gap-2">
                                                    <Fingerprint
                                            ...
                                            <div className="flex justify-end gap-2 mt-5">
                                                    ...
                                                    <>
                                                        <button
                                                            ...
                                                            className=" border-0 py-1 md:gap-3 gap-1 hover:bg-accent1 px-6 w-[100px] md:w-full text-l font-medium bg-[#F2D323] text-black rounded-md shadow-md flex items-center justify-center transform hover:scale-105 transition-transform duration-300"
                                                        >
                                                            Reset
                                                        </button>
                                                    </>
                                                    ...
                                                    <button
                                                        onClick={handleClose}
                                                        className="py-1 px-6 text-l font-medium rounded-md md:w-full w-[70px] flex justify-center shadow-md border-4 border-accent text-accent1 transform hover:scale-105 transition-transform duration-300"
                                                    >
                                                        Back
                                                    </button>
