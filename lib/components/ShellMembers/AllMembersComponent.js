...
export default function AllMembersComponent({ handleBack, allRegister, allBranch, userLogIn, searchInput, hideForUser }) {
                                        ...
                                        {!hideForUser && (
                                            <td className="border-b py-3 font-normal text-[14px] text-dark border-r">
                                                <div className="flex gap-2 justify-center">
                                                    {/* Pass the selected member data to DeleteUser */}
                                                    <DeleteUser selectedMember={data} userLogIn={userLogIn} />
                                                </div>
                                            </td>
                                        )}
                                    </tr>
