...
export default function DailySales({ userLogIn, allDailySales, allActualPOS, handleDailySave }) {
    ...
    return (
        <>
                                                        ...
                                                        <div className="flex justify-center items-center gap-2">
                                                            {sale.actualPos && sale.overShortage ? (
                                                                ...
                                                                (lastShift === "FC1" || lastShift === "FC2") ? (
                                                                    ...
                                                                    <AddTotalModal userLogIn={userLogIn} date={sale.date} salesData={filteredSalesForDate} handleDailySave={handleDailySave} />
                                                                )
                                                            )}
                                                        </div>
                                                    </td>
            ...
            {selectedDate && (
                <DateDailySalesDetails sales={filteredSales} userLogIn={userLogIn} closeDetails={closeDetails} handleDailySave={handleDailySave} />
            )}
        </>
    );
}