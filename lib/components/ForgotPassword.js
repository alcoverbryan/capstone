...
export default function ForgotPassword({UserLogIn}) {
    ...
    return (
        <div className="flex justify-center bg-slate-50 p-2">
            <div className="w-full md:w-9/12 border-0 border-red-500">
                <div className="mb-20 mt-6 bg-white border-b border-r shadow-md rounded-lg p-4 text-l font-medium flex items-center space-x-2">
                    <span class="text-[12px] md:text-[18px] text-nowrap text-dark font-medium">Account Settings</span>
                    <Chevron_right className="h-4 w-4 text-gray-500 " />
                    <span class="text-[12px] md:text-[18px] text-nowrap font-[700] text-dark">Account</span>
                </div>
                        ...
                        <div className=" p-4 mb-10 border bg-white w-full rounded-lg shadow-md">
                            ...
                            <div className=" flex justify-left items-center mb-9">
                                ...
                                <div className="border-0">
                                    ...
                                    <p className="font-semibold flex text-[16px] text-dark focus:outline-none mb-4 gap-2">{UserLogIn.id}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="  border-0 mb-8 ">
                                <div className="w-full border-0  mt-5 px-4">
                                    <form action="/api/forgotPassword" method="POST">
                                        ...
                                        <button
                                            type="submit"
                                            class="border-0 py-2 mt-6 mb-3 md:gap-3 gap-1 hover:bg-accent1 px-6 w-full md:w-full text-l font-medium bg-accent1 text-light rounded-md shadow-md flex items-center justify-center transform hover:scale-105 transition-transform duration-300"
                                        >
                                            <Plus className="h-4" />
                                            Reset Password
                                        </button>
