...
export default function DateDailySalesDetails({ sales, userLogIn, closeDetails, handleDailySave }) {
    ...
    return (
        <>
            <div className="mt-10 bg-white rounded-md">
                <div className="flex justify-between mb-10 p-4 shadow-md bg-white items-center">
                    ...
                    <div className="flex justify-end">
                        {lastShift !== "FC3" && <AddDailySalesModal userLogIn={userLogIn} sales={sales} handleDailySave={handleDailySave} />}
                    </div>
                </div>
            ...
            >
                <div className="py-1 px-6 text-l font-medium bg-[#E63946] text-[#FFFFFF] rounded-md hover:bg-[#D62839] border border-accent1 text-accent1 shadow-md">Back</div>
            </button>
        </>
    );
}
