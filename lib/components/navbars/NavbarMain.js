    ...
    return (
        <Navbar className="h-12 bg-[#F2D323] text-white px-3 py-3">
            ...
            <div className="flex flex-row w-full justify-end">
                ...
                <div className="relative">
                    <div className="flex border-0 items-center h-full">
                        <button  className="text-sm text-black font-semibold" onClick={toggleUserDropdown}>{userLogIn.full_name}</button>
