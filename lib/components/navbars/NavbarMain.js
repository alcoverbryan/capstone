                            ...
                            <div className="absolute right-0 mt-3 text-black border bg-white shadow-lg rounded-lg w-48">
                                <ul>
                                    ...
                                    >
                                        ...
                                        <h1 className="block px-4 py-2 text-gray-700"><MyProfile userLogIn={userLogIn}/></h1>
                                    </li>
                                    {!hideForUser && (
                                        <li
                                            className="flex items-center px-4 justify-start hover:bg-gray-100 cursor-pointer"
                                        >
                                            ...
                                            <h1 className="block px-4 py-2 text-gray-700"><Settings userLogIn={userLogIn} displayAllPendingPassword={displayAllPending} getPendingUsers={getPendingUsers} allBranch={allBranch} /></h1>
                                        </li>
                                    )}
                                    <li className="flex items-center px-4 justify-start hover:bg-gray-100">
                                        <PowerIcon className="w-4 h-4" />
                                        <form action="/api/logout">
                                            <button className="block px-4 py-2 text-gray-700 ml-2">
                                                Logout
                                            </button>
                                        </form>
                                    </li>
