...
export default function NavbarMain({ title, userLogIn, allBranch,handleBackToHome }) {
                                    ...
                                    <ul className="flex justify-center">
                                        {allBranch.map((branch) => (
                                            <li key={branch.id} className="mb-2">
                                                <p className="font-semibold text-nowrap flex justify-center border-0">{branch.branch_name}</p>
                                            </li>
                                        ))}
                                    </ul>
