...
export default function ActualFuelPrices({ allFuelPrices, showGraph, userLogIn, handleFuelPricesSave }) {
                                    ...
                                    return (
                                        <div 
                                            style={{
                                                ...
                                                padding: '25px',             // Adjust padding for better look
                                                borderRadius: '5px',         
                                                fontSize: '18px',            
                                                color: 'black',              
                                        ...
                                        >
                                            {/* Styled date with red color and increased font size */}
