...
export default function addBranchModal ({userLogIn}){
    return (
        <>
                            ...
                            <div className="md:w-[350px]">
                                ...
                                <div className="mb-3">
                                    ...
                                    <select
                                        ...
                                        required
                                    >
                                        <option value="VPN+">VPN+ (Premium)</option>
                                        <option value="FSG">FSG (Unleaded)</option>
                                        <option value="Shell V-Power Racing">Shell V-Power Racing</option>
                                        <option value="FSD">FSD (Diesel)</option>
                                        <option value="VPN+D">VPN+D</option>
                                    </select>
                                </div>
                                <div className="mb-3">
