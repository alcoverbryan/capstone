    ...
    <Modal title="Fuel Prices" icon={<PlusCircle className="w-7 h-7" />}>
      <div className="flex justify-evenly max-w-full">
        <form className="w-full max-w-full" onSubmit={handleSubmit}>
          ...
          <table className="table-auto w-full text-sm text-left border-separate border-spacing-1">
            <thead>
              <tr>
                <th className="px-4 py-1 text-black font-semibold">Fuel Type</th>
                <th className="px-4 py-1 text-black font-semibold">RSOP</th>
                <th className="px-4 py-1 text-black font-semibold">APP Bennros Shell</th>
                <th className="px-4 py-1 text-black font-semibold">Petron Highway</th>
                <th className="px-4 py-1 text-black font-semibold">Caltex</th>
                <th className="px-4 py-1 text-black font-semibold">Total</th>
                <th className="px-4 py-1 text-black font-semibold">Rephil</th>
                <th className="px-4 py-1 text-black font-semibold">Shell Affinis</th>
              </tr>
            </thead>
            <tbody>
