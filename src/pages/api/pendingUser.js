    ...
    try {
        ...
        if (tempOtpStorage[email]) {
            ...
            if (storedOtpData.otp === trimmedOtp) {
                ...
                let position;
                const existingUsers = await db_conn.getRegister(); // Fetch existing users
                ...
                // Choose the appropriate method based on the position
                if (position === "Admin") {
                    ...
                    console.log("Admin registered directly.");
                } else {
                    await db_conn.createPendingUser(
                        first_name,
                        last_name,
                        gender,
                        permanent_address,
                    ...
                    console.log("User added to pending registrations.");
                }
                ...
                res.status(200).json({ message: `${position} registered successfully.` });
